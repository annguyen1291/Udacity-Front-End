...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    // Change querySelectorAll into getElementsByClassName for better performance
...
// Move definition of pizzasDiv out of for loop, makes one DOM call and use it in the loop.
...
function updatePositions() {
  ...
  //Define 5 different phases before the loop then use them inside the loop depending on i value.
  var phases = []
  for (var i =0; i < 5; i++) {
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  // Move definition of movingPizza out of for loop, makes one DOM call and use it in the loop.
  // Change querySelectorAll into getElementsByClassName for better performance
